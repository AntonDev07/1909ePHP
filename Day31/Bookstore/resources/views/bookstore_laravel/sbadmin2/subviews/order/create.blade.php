        ...
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Thêm đơn hàng</h6>
                ...
                <div class="card-body">
                    ...
                    <h2>Helloooo</h2>
                    <form name="order" action="{{ url('backend/sbadmin2/create') }}" method="post">

                        {{ csrf_field() }}

                        <div class="form-group">
                            <label>Customer ID</label>
                            <input type="number" name="customer_id" class="form-control " value="" min="1" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="payment_firstname" class="form-control" value="">

                        </div>
                        <div class="form-group">
                            <label>Payment Lastname</label>
                            <input type="text" name="payment_lastname" class="form-control" value="">
                        </div>
                        <div class="form-group">
                            <label>Payment Address</label>
                            <input type="text" name="payment_address" class="form-control" value="">

                        </div>
                        <div class="form-group">
                            <label>Payment Company</label>
                            <input type="text" name="payment_company" class="form-control" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shipping_firstname" class="form-control" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shipping_lastname" class="form-control" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shipping_address" class="form-control" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shipping_company" class="form-control" value="">
