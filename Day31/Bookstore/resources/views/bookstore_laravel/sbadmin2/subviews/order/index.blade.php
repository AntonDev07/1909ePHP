        ...
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a href="{{ url('/backend/sbadmin2/create') }}" class="m-0 font-weight-bold text-primary">Thêm đơn hàng</a>
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="Xem" href="{{url("/backend/sbadmin2/books/index/$order->order_id")}}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                <a href="{{ url("/backend/sbadmin2/edit/$order->order_id")}}" class="btn btn-light">Sửa</a>
                                <a href="{{ url("/backend/sbadmin2/delete/$order->order_id")}}" class="btn btn-dark">Xóa</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
